...
"status":"compleated",
"picked": true,
"driver_phone":"656776576",
    "price":value.price,
    "origin":pink[0].OrginalPincode,
    "destination":pink[0].DestinationPincode,
    "item_weight":sign[0].item_weight,
    "item_name":sign[0].item_name,
    "services":"premium",
    "date": sign[0].date,
    "pickup_address":ink,
    "delivery_address":info,
    "receiver_name":sign[0].receiver_name,
    "receiver_phone":sign[0].receiver_phone
